<div class="Meetup__sponsors" id="sponsors">
    ...
    <div class="Meetup__sponsorsWrapper">
        ...
        <a class="Meetup__sponsor" href="https://www.themexpert.com/" target="_blank"><img src="{{ asset('phpxperts/images/sponsors/sponsor6.png') }}" alt="sponsor"></a>
    </div>
    <h4 class="Meetup__sectionTitle">Payment partner</h4>
    <div class="Meetup__sponsorsWrapper">
        <a class="Meetup__sponsor" href="https://aamarpay.com/" target="_blank"><img src="{{ asset('phpxperts/images/aamarpay.png') }}" alt="sponsor"></a>
    </div>
</div>
