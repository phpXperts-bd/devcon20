<div class="Meetup__speakers" id="speakers">
    ...
    <div class="Speaker">
        <div class="Speaker__avatar"><img src="{{ asset('phpxperts/images/mozammel.jpeg') }}" alt="speaker" style="border-radius: 40px"></div>
        <div class="Speaker__content">
...
{{--    </div>--}}
    <div class="Speaker">
        ...
        <div class="Speaker__content">
            ...
            <p class="Speaker__role">Chief Technology Officer (CTO), Authlab</p>
