...
<link rel="shortcut icon" href="{{ asset('devcon20/favicon/favicon-16x16.png') }}">
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('devcon20/favicon/apple-touch-icon.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('devcon20/favicon/favicon-32x32.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('devcon20/favicon/favicon-16x16.png') }}">
<link rel="manifest" href="{{ asset('devcon20/favicon/site.webmanifest') }}">
...
<link rel="stylesheet" href="{{ asset('devcon20/styles/main.css') }}">
